...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["app.luminate.co.nz"])
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="Luminate Financial Group Loan Prortal <noreply@app.luminate.co.nz>",
)
...
EMAIL_SUBJECT_PREFIX = env(
    ...
    default="[Luminate Financial Group Loan Prortal] ",
)
...
# Anymail - DISABLED
# ------------------------------------------------------------------------------
# SendGrid no longer offers free tier - using console backend instead
